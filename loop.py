...
class Reactor (object):
	...
	def route_send (self):
		...
		self.answer(process_service,"Performing dynamic route update")
		#print Protocol(self).Getupdates()
		for key in self.configuration.neighbor.keys():
			self.peers[key].send_new()
		self.answer(process_service,"Updated peers dynamic routes successfully")
		#self.writeOnlyStdio(process_service,"Updated peers dynamic routes successfully")#eason				
	...
	def route_flush (self):
		...
		self.answer(process_service,"Performing route flush")
		#self.logger.reactor("Performing route flush")
		#self.writeOnlyStdio(process_service,"Performing route flush")#eason	
		for key in self.configuration.neighbor.keys():
	...
	def writeOnlyStdio (self, service, string):#eason
		self.processes.write(service,string)
